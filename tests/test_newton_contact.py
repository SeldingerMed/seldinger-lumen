...
def _run(enable_contact, preload=120.0, nsteps=200, barrier_mode="compliant"):
    R = 2.0
    sim = NewtonGuidewireSim(_vessel(), R, _device_points(), radius=0.2,
                             stretch_stiffness=1e4, bend_stiffness=4e1,
                             kappa=2e3, d_hat=0.3, barrier_mode=barrier_mode,
...
def test_barrier_modes_hold_at_near_zero_penetration():
    R = 2.0
